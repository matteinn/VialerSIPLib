...
+ (NSString *)cleanPhoneNumber:(NSString *)phoneNumber {
    ...
    phoneNumber = [[phoneNumber componentsSeparatedByCharactersInSet:[[NSCharacterSet characterSetWithCharactersInString:@"+0123456789*#qwertyuiopasdfghjklzxcvbnm"] invertedSet]] componentsJoinedByString:@""];
